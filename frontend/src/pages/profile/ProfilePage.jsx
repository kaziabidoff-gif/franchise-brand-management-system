    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-5 lg:grid-cols-[20rem_1fr]">
        <aside className="rounded-lg border border-slate-200 bg-white p-5">
          <img className="h-24 w-24 rounded-full object-cover" src={profile.avatar_url} alt={profile.name} />
          ...
          <p className="mt-4 text-sm text-slate-500">{profile.branch_name || 'Headquarters'}</p>
        </aside>
        <form className="rounded-lg border border-slate-200 bg-white p-5" onSubmit={handleSubmit(submit)}>
